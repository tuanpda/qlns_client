<template>
  <div class="box">
    <div class="table_wrapper">
      ...
      >
        <thead style="font-weight: bold; background-color: aliceblue">
          <tr>
            ...
            <th style="font-size: small; text-align: center; width: 15%">
              Họ tên
            </th>
            <th style="font-size: small; text-align: center; width: 5%">
              Ngày sinh
            ...
            <th style="font-size: small; text-align: center; width: 12%">
              Tuổi hiện nay
            </th>
            ...
            <th style="font-size: small; text-align: center; width: 8%">
              Số tháng còn lại
            </th>
            <th style="font-size: small; text-align: center; width: 8%">
              Tháng hưởng hưu
            ...
            <th style="font-size: small; text-align: center; width: 4%">
              Độc hại?
            </th>
          </tr>
        </thead>
      ...
      <!-- Phân trang -->
      <div
        class="pagination-container is-flex is-align-items-center"
        style="gap: 0.5rem"
      >
