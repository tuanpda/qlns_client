        ...
        >
          <thead style="font-weight: bold; background-color: #e9ecef">
            <tr>
              ...
              <th style="text-align: center">Mã Chi nhánh</th>
          ...
          <tbody>
            <tr v-for="(item, index) in chinhanh" :key="index">
              ...
              <td style="text-align: center; vertical-align: middle">
                <a
                  @click="
                    userRole == 1 || userRole == 2 ? editChinhanh(item) : null
                  "
          ...
          <section class="modal-card-body">
            ...
            >
              <div>
                ...
                <span style="font-weight: bold">Thêm Chi nhánh</span>
              </div>
              <div>
                <button
            ...
            <div class="field">
              <label class="label">Mã Chi nhánh</label>
              <div class="control">
                <input
            ...
            <div class="field">
              <label class="label">Tên Chi nhánh</label>
              <div class="control">
                <input
                  v-model="formAddNew.tenChiNhanh"
                  class="input"
                  type="text"
                />
              </div>
          ...
          <section class="modal-card-body">
            ...
            >
              <div>
                ...
                <span style="font-weight: bold">Sửa thông tin Chi nhánh</span>
              </div>
              <div>
                <button
  ...
  methods: {
    ...
    async onSave() {
      if (this.userRole == 1 || this.userRole == 2) {
        ...
        const result = await Swal.fire({
          title: `Xác nhận thêm mới chi nhánh ?`,
          showDenyButton: true,
          ...
          try {
            ...
            if (res.status === 200) {
              ...
              Swal.fire({
                ...
                text: `Đã thêm mới chi nhánh tên: ${this.formAddNew.tenChiNhanh}`,
                icon: "success",
              });
              // ghi log
              const dataLog = {
                meNu: "Danh mục / Chi nhánh",
    ...
    async onEditApply() {
      if (this.userRole == 1 || this.userRole == 2) {
        ...
        const result = await Swal.fire({
          title: `Xác nhận sửa thông tin chi nhánh ?`,
          showDenyButton: true,
        ...
        if (result.isConfirmed) {
          ...
          try {
            ...
            Toast.fire({
              icon: "error",
              title: `Lỗi! Không thể sửa thông tin`,
            });
          }
        }
      }
          ...
          try {
            ...
            if (res.status === 200) {
              ...
              Swal.fire({
                ...
                text: `Đã xoá chi nhánh: ${data.tenChiNhanh}`,
                icon: "success",
              });
