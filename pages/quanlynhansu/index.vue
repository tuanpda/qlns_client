<template>
  <div style="background-color: #e9ecef; padding: 10px">
          ...
          <div class="field is-grouped">
            <div class="control">
              <input
                ...
                type="text"
                v-model="searchQuery"
                placeholder="🔍 Tìm kiếm theo thông tin theo Họ tên, Ngày sinh, Chi nhánh, Phòng ban ..."
                style="width: 500px"
              />
            </div>
            <!-- <div class="control">
          ...
          <tbody>
            <tr v-for="(item, index) in paginatedTable" :key="index">
              ...
              <td style="text-align: center; vertical-align: middle">
                ...
                <a
                  @click="
                    userRole == 1 || userRole == 2 ? onChange(item) : null
                  "
                  :class="{ 'disabled-link': userRole !== 1 && userRole !== 2 }"
                  :title="
                    userRole == 1 || userRole == 2
                      ? 'Chuyển đổi đơn vị'
                      : 'Bạn không có quyền chuyển'
                  "
                >
              ...
              <div class="column">
                ...
                <p>
                  <i
                    ...
                    style="color: #fd7e14; margin-right: 5px"
                  ></i>
                  <strong>Thời gian bắt đầu hợp đồng:</strong>
                  <span style="font-weight: bold; color: #0d6efd">{{
                ...
                <p>
                  <i
                    ...
                    style="color: #fd7e14; margin-right: 5px"
                  ></i>
                  <strong>Thời gian kết thúc hợp đồng:</strong>
                  <span style="font-weight: bold; color: #0d6efd">{{
    ...
    <!-- modal change human -->
    <div class="">
      <div :class="{ 'is-active': isActive_Change }" class="modal">
        <div class="modal-background"></div>
        <div
          class="modal-content modal-card-change box"
          :style="{
            height: isChange ? '700px' : '350px',
        ...
        >
          <section class="modal-card-body">
            ...
            >
              <div>
                ...
                <span style="font-weight: bold"
                  >Chuyển đổi đơn vị công tác</span
                >
              </div>
              <div>
                <button
                  @click="isActive_Change = false"
                  class="button is-small is-info"
                >
                  Thoát
                </button>
            ...
            <div v-if="detailHumanChange" style="margin-top: 10px">
              <div class="field">
                <label class="label">Họ tên</label>
                <div class="control">
                  <input
                    v-model="detailHumanChange.hoTen"
                    ref="nameInput"
                    class="input"
                    type="text"
                    disabled
              ...
              <div class="columns is-multiline">
                <div class="column is-5">
                  <div class="field">
                    <label class="label">Vị trí công tác</label>
                    <div class="control">
                      <input
                        v-model="detailHumanChange.viTriCongTac"
                ...
                <div class="column">
                  <template v-if="detailHumanChange.isphongban == 1">
                    <div class="field">
                      <label class="label">Đơn vị hiện nay</label>
                      <div class="control">
                        <input
                          v-model="detailHumanChange.phongBan"
                          class="input"
                          type="text"
                          disabled
                        />
                  ...
                  <template v-else>
                    <div class="field">
                      ...
                      <div class="control">
                        <input
                          v-model="detailHumanChange.chiNhanh"
                          class="input"
                          type="text"
                        />
                      </div>
              ...
              <div class="field">
                <label class="checkbox">
                  <input v-model="isChange" type="checkbox" />
                  <span style="font-weight: bold; color: #dc3545"
                    >Đổi đơn vị công tác</span
                  >
                  <br />
                  <span style="color: #dc3545"
                    >* Lưu ý là nếu muốn đổi tên vị trí công tác thì đổi vào vị
                    trí hiện tại bên trên</span
                  >
                </label>
              </div>

              <div class="box" v-if="isChange == 1">
                <div class="field">
                ...
                <template v-if="isPbCn == 1">
                  <div class="field">
                    <label class="label" style="color: #dc3545"
                      >Chọn Đơn vị đến</label
                    >
                    <div class="control">
                      <div class="select is-fullwidth">
                        <select
                          v-model="selectedBrandPb"
                          @change="phongBanChange_Change"
                          :disabled="!lockDonvi"
                        >
                ...
                <template v-else>
                  <div class="field">
                    ...
                    <div class="control">
                      <div class="select is-fullwidth">
                        <select
                          v-model="selectedBrandCn"
                          @change="chiNhanhChange_Change"
                          :disabled="!lockDonvi"
                        >
                          <option selected disabled>-- --</option>
                          <option
                ...
                <div class="field is-grouped-function">
                  <div class="control">
                    <button @click="onSaveChange()" class="button is-success">
                      Chuyển đổi
                    </button>
                  </div>
                  &nbsp;
...
export default {
      ...
      return this.listNhanSu.filter(
        (item) =>
          ...
          item.chiNhanh
            .toLowerCase()
            .includes(this.searchQuery.toLowerCase()) ||
          item.ngaySinh.toLowerCase().includes(this.searchQuery.toLowerCase())
      );
    },
  ...
  methods: {
    ...
    async phongBanChange_Change(e) {
      this.selectedBrandCn = "";
      const selectedMaPhongBan = e.target.value;
      ...
      // Nếu tìm thấy, gán tên phòng ban
      if (selectedPhongBan) {
        this.tenPhongBanChange = selectedPhongBan.tenPhongBan;
        this.maPhongBanChange = selectedMaPhongBan;
        this.checkNullDVCD = 1;
      }
    },

    async chiNhanhChange_Change(e) {
      this.selectedBrandPb = "";
      const selectedMaChiNhanh = e.target.value;
      ...
      // Nếu tìm thấy, gán tên phòng ban
      if (selectedChiNhanh) {
        this.tenChiNhanhChange = selectedChiNhanh.tenChiNhanh;
        this.maChiNhanhChange = selectedMaChiNhanh;
        this.checkNullDVCD = 1;
      }
    },
    ...
    async onSaveEdit() {
      if (this.userRole == 1 || this.userRole == 2) {
        ...
        if (result.isConfirmed) {
          ...
          let data = new FormData();
          data.append("_id", this.detailHuman._id);
          ...
          try {
            ...
            if (res.status === 200) {
              ...
              Swal.fire({
                ...
                text: `Đã xoá nhân sự: ${data.hoTen}`,
                icon: "success",
              });
    ...
    async onChange(data) {
      this.detailHumanChange = {};
      this.detailHumanChange = data;
      this.isActive_Change = true;
    },

    async onSaveChange() {
      if (this.checkNullDVCD == 0) {
        Swal.fire({
          title: "Cảnh báo",
          text: "Chưa chọn đơn vị cần chuyển đến!",
          icon: "error",
        });
      } else {
        this.lockChuyenDoi == true;
        // console.log(this.isPbCn); chi nhánh là 0, phòng ban là 1
        // console.log(this.detailHumanChange);
        // check hiện nay là phòng hay chi nhánh
        // console.log(this.detailHumanChange.isphongban);
        if (this.detailHumanChange.isphongban == true) {
          // người này đang ở phòng ban
          // giờ muốn chuyển đi đâu???
          // nếu sang phòng ban khác thì ...
          if (this.isPbCn == 1) {
            // đổi sang phòng ban
            // console.log(this.maPhongBanChange);
            // console.log(this.tenPhongBanChange);
            // 1. nếu từ phòng ban sang phòng ban khác
            // thì chỉ cần đổi tên phòng ban là ok
            this.maChiNhanhChange = "";
            this.tenChiNhanhChange = "";

            const dataChange = {
              _id: this.detailHumanChange._id,
              maPhongBan: this.maPhongBanChange,
              phongBan: this.tenPhongBanChange,
              viTriCongTac: this.detailHumanChange.viTriCongTac,
              ghiChu: this.ghichuChange,
            };

            const result = await Swal.fire({
              title: "Đang đổi giữa các phòng ban",
              text: `Bạn đang thực hiện đổi đơn vị từ phòng ${this.detailHumanChange.phongBan} sang phòng ${this.tenPhongBanChange} ?`,
              showDenyButton: true,
              confirmButtonText: "Xác nhận",
              denyButtonText: `Hủy`,
            });
            if (result.isConfirmed) {
              this.isLoading = true;
              const res = await this.$axios.post(
                `/api/empl/change-empl-phong-to-phong`,
                dataChange
              );
              ...
              if (res.status === 200) {
                ...
                Swal.fire({
                  ...
                  text: `Đã chuyển ${this.detailHumanChange.hoTen} từ phòng ${this.detailHumanChange.phongBan} sang phòng ${this.tenPhongBanChange}`,
                  icon: "success",
                });
                ...
                const dataHistory = {
                  noiDung: `Chuyển ${this.detailHumanChange.hoTen} từ phòng ${this.detailHumanChange.phongBan} sang phòng ${this.tenPhongBanChange}`,
                  createdAt: current,
                  createdBy: this.createdBy,
                  ghichu: this.ghichuChange,
                };
                ...
                await this.$axios.post(
                  `/api/empl/his-change-empl`,
                  dataHistory
                );

                // Reset form hoặc cập nhật danh sách
                this.getNhansu();
                this.isActive_Change = false;
                this.isChange = 0;
                this.selectedBrandPb = "";
                this.selectedBrandCn = "";
                this.ghichuChange = "";
                this.lockDonvi = false;
              }
            }
          } else {
            // 2. đây là trường hợp mà từ phòng ban sang chi nhánh
            // thì tiến hành ghi tên chi nhánh và làm rỗng 2 trường mã và tên phòng
            // bỏ selected cũ
            this.maPhongBanChange = "";
            this.tenPhongBanChange = "";

            const dataChange = {
              _id: this.detailHumanChange._id,
              maChiNhanh: this.maChiNhanhChange,
              chiNhanh: this.tenChiNhanhChange,
              viTriCongTac: this.detailHumanChange.viTriCongTac,
              ghiChu: this.ghichuChange,
            };

            const result = await Swal.fire({
              title: "Đang đổi từ Phòng ban sang Chi nhánh",
              text: `Bạn đang thực hiện đổi từ phòng ${this.detailHumanChange.phongBan} sang chi nhánh ${this.tenChiNhanhChange} ?`,
              showDenyButton: true,
              confirmButtonText: "Xác nhận",
              denyButtonText: `Hủy`,
            });
            if (result.isConfirmed) {
              const res = await this.$axios.post(
                `/api/empl/change-empl-phong-to-chinhanh`,
                dataChange
              );
              ...
              if (res.status === 200) {
                ...
                Swal.fire({
                  title: "Chuyển đổi thành công",
                  text: `Đã chuyển ${this.detailHumanChange.hoTen} từ phòng ${this.detailHumanChange.phongBan} sang chi nhánh ${this.tenChiNhanhChange}`,
                  icon: "success",
                });
                ...
                const dataHistory = {
                  noiDung: `Chuyển ${this.detailHumanChange.hoTen} từ phòng ${this.detailHumanChange.phongBan} sang chi nhánh ${this.tenChiNhanhChange}`,
                  createdAt: current,
                  createdBy: this.createdBy,
                  ghichu: this.ghichuChange,
                };
          ...
          // ngược lại nếu đơn vị hiện tại là chi nhánh thì ...
          if (this.isPbCn == 0) {
            // 1. nếu chuyển sang chi nhánh khác
            // thì chỉ cập nhật lại tên và mã chi nhánh khác
            const dataChange = {
              _id: this.detailHumanChange._id,
              maChiNhanh: this.maChiNhanhChange,
              chiNhanh: this.tenChiNhanhChange,
            ...
            const result = await Swal.fire({
              title: "Đang đổi giữa các chi nhánh",
              text: `Bạn đang thực hiện đổi đơn vị từ chi nhánh ${this.detailHumanChange.chiNhanh} sang chi nhánh ${this.tenChiNhanhChange} ?`,
              showDenyButton: true,
              confirmButtonText: "Xác nhận",
              denyButtonText: `Hủy`,
            });
            if (result.isConfirmed) {
              const res = await this.$axios.post(
                `/api/empl/change-empl-chinhanh-to-chinhanh`,
                dataChange
              );
              ...
              if (res.status === 200) {
                ...
                Swal.fire({
                  title: "Chuyển đổi thành công",
                  text: `Đã chuyển ${this.detailHumanChange.hoTen} từ chi nhánh ${this.detailHumanChange.chiNhanh} sang chi nhánh ${this.tenChiNhanhChange}`,
                  icon: "success",
                });
                ...
                const dataHistory = {
                  noiDung: `Chuyển ${this.detailHumanChange.hoTen} từ chi nhánh ${this.detailHumanChange.chiNhanh} sang chi nhánh ${this.tenChiNhanhChange}`,
                  createdAt: current,
                  createdBy: this.createdBy,
                  ghichu: this.ghichuChange,
                };
            ...
            // 2. nếu chuyển sang phòng thì làm trống trường mã và tên chi nhánh đi
            const dataChange = {
              _id: this.detailHumanChange._id,
              maPhongBan: this.maPhongBanChange,
              phongBan: this.tenPhongBanChange,
            ...
            const result = await Swal.fire({
              title: "Đang đổi từ chi nhánh sang phòng ban",
              text: `Bạn đang thực hiện đổi đơn vị từ ${this.detailHumanChange.chiNhanh} sang đơn vị mới là: ${this.tenPhongBanChange} ?`,
              showDenyButton: true,
              confirmButtonText: "Xác nhận",
              denyButtonText: `Hủy`,
            });
            if (result.isConfirmed) {
              const res = await this.$axios.post(
                `/api/empl/change-empl-chinhanh-to-phongban`,
                dataChange
              );
              ...
              if (res.status === 200) {
                ...
                Swal.fire({
                  title: "Chuyển đổi thành công",
                  text: `Đã chuyển ${this.detailHumanChange.hoTen} từ chi nhánh ${this.detailHumanChange.chiNhanh} sang phòng ${this.tenPhongBanChange}`,
                  icon: "success",
                });
                ...
                const dataHistory = {
                  noiDung: `Chuyển ${this.detailHumanChange.hoTen} từ chi nhánh ${this.detailHumanChange.chiNhanh} sang phòng ${this.tenPhongBanChange}`,
                  createdAt: current,
                  createdBy: this.createdBy,
                  ghichu: this.ghichuChange,
                };
