          ...
          <div class="field is-grouped">
            <div class="control">
              <input
                ...
                type="text"
                v-model="searchQuery"
                placeholder="🔍 Tìm theo (Tên chi bộ, tên đảng viên, trình độ chuyên môn)..."
                style="width: 500px"
              />
            </div>
            <div class="control">
        ...
        >
          <thead style="font-weight: bold; background-color: aliceblue">
            <tr>
              ...
              <th style="font-size: small; text-align: center">Chi bộ</th>
              ...
              <th style="font-size: small; text-align: center">Dự bị?</th>
              <th style="font-size: small; text-align: center">Ghi chú</th>
            </tr>
          </thead>
          <tbody>
            <tr v-for="(item, index) in paginatedTable" :key="index">
              ...
              <td
                ...
                "
              >
                <template v-if="item.isDuBi == 1">
                  <span style="color: #dc3545">Dự bị</span>
                </template>
                <template v-else>
...
export default {
  ...
  methods: {
    ...
    async getNhansu() {
      const res = await this.$axios.get("/api/empl/all-emp-dangvien");
      //   console.log(data);
