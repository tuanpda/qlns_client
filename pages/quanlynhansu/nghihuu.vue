        ...
        >
          <thead style="font-weight: bold; background-color: aliceblue">
            <tr>
              ...
              <th style="font-size: small; text-align: center">Vị trí</th>
              ...
              <th style="font-size: small">Nơi cư trú</th>
              <th style="font-size: small; text-align: center">Trình độ</th>
              <th style="font-size: small; text-align: center">Chuyên môn</th>
            </tr>
          </thead>
          <tbody>
...
export default {
  ...
  methods: {
    ...
    async getNhansu() {
      const res = await this.$axios.get("/api/empl/all-emp-nghihuu");
      //   console.log(data);
